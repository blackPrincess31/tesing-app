    ...
    return (
        <div className="Post">
            <form className="someText">
                <textarea value={props.value} onChange={props.handleChange} placeholder="Введите техт"></textarea>
                <button className="save" onClick={props.handleSubmit}>Сохранить</button>
            </form>
